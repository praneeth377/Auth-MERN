  ...
  return (
    <div className="p-3 max-w-lg mx-auto border-2 border-blue-500">
      ...
      <form className="flex flex-col gap-5">
        ...
        <img src={currentUser.profile_pic} alt="profile-pic" onClick={() => fileRef.current.click()} className="h-24 w-24 self-center cursor-pointer rounded-full object-cover mt-2" />
